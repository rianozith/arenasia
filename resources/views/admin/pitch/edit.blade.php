...
<div class="row">
	<div clss="col-lg-12">
		<ol class="breadcrumb">
			...
			<li><a href="{{ url('dashboard/pitch') }}">Pitch</a></li>
			<li class="active">Edit - {{ $pitches->nama_lapangan }}</li>
		</ol>
	</div>
</div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
									...
									{!! Form::model($pitches,['route' => ['pitch.update', $pitches], 'method' => 'PUT', 'class'=>'form-horizontal form-label-left', 'data-parsley-validate']) !!}
										{{ csrf_field() }}

								    @include('admin.pitch._form')
