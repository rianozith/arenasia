...
<div class="row">
	<div clss="col-lg-12">
		<ol class="breadcrumb">
			...
			<li class="active">Edit - {{ $profile->profilename }}</li>
		</ol>
	</div>
</div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
									...
									{!! Form::model($profile,['route' => ['profile.update', $profile], 'method' => 'PUT', 'class'=>'form-horizontal form-label-left', 'data-parsley-validate']) !!}
										{{ csrf_field() }}
